async function getdata(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Home%20and%20Kitchen`)
...
function display(data){
    ...
    let container=document.getElementById("homekitchen")
...
async function high(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Home%20and%20Kitchen&_sort=discounted_price&_order=desc`)
...
async function low(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Home%20and%20Kitchen&_sort=discounted_price&_order=asc`)
