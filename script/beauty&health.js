async function getdata(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Beauty%20and%20health`)
...
function display(data){
    ...
    let container=document.getElementById("beautyhealth")
...
async function high(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Beauty%20and%20health&_sort=discounted_price&_order=desc`)
...
async function low(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Beauty%20and%20health&_sort=discounted_price&_order=asc`)
