async function getdata(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Sarees`)
...
function display(data){
    ...
    let container=document.getElementById("womenethnic")
...
async function high(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Sarees&_sort=discounted_price&_order=desc`)
...
async function low(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Sarees&_sort=discounted_price&_order=asc`)
