async function getdata(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Bags%20and%20Footwear`)
...
function display(data){
    ...
    let container=document.getElementById("bagsfootwear")
...
async function high(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Bags%20and%20Footwear&_sort=discounted_price&_order=desc`)
...
async function low(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Bags%20and%20Footwear&_sort=discounted_price&_order=asc`)
