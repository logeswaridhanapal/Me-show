async function getdata(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Mens%20Top%20Were`)
...
async function high(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Mens%20Top%20Were&_sort=discounted_price&_order=desc`)
...
async function low(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?category=Mens%20Top%20Were&_sort=discounted_price&_order=asc`)
