...
async function high(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?_sort=discounted_price&_order=desc`)
...
async function low(){
    ...
    let res=await fetch(`https://meesho-backend-3037.onrender.com/products?_sort=discounted_price&_order=asc`)
